...
export function openBrowser(initialUrl = 'google://home') {
    ...
    const isLiveUsb = sessionStorage.getItem('krypton_current_boot_medium') === 'live_usb';
    const isUpgraded = !isLiveUsb;
...
export { openBrowser as openKryptonBrowser, openBrowser as openWebBrowser };
